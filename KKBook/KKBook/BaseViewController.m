...
- (void)viewDidLoad {
    ...
    //((BaseNavigationController*)self.navigationController).navigationBar.tintColor = [UIColor KKBookOrangeColor];
}
...
- (void)setNavigationBar{
    ((BaseNavigationController*)self.navigationController).navigationBar.barTintColor = [UIColor KKBookNavigationColor];
}
